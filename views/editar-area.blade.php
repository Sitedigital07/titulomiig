...
@endforeach
     ...
     <div class="container">
                                ...
                                <div class="block">
                                    ...
                                    {{ Form::open(array('method' => 'POST','class' => 'form-horizontal','id' => 'defaultForm', 'url' => array('/editargrado',$grados->id))) }}
                                       
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="example-text-input">Grado</label>
                                            <div class="col-md-9">
                                                {{Form::text('area', $grados->grado, array('class' => 'form-control','placeholder'=>''))}}
                                            </div>
                                        </div>
